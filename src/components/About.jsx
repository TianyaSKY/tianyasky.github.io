    ...
    <section id="about" className="section-inner">
      ...
      <div className="about-grid">
        <div className="about-prose">
          ...
          <p>
            科研侧，我以<strong>国家级大创项目第一负责人</strong>身份推进近海单目视觉定位，并在密集视觉领域攻关 <strong>YOLO-PGMD 概率引导人群计数</strong>：针对极端遮挡与大尺度跨度设计积分守恒高斯标签与概率空间注意力，在 ShanghaiTech Part A 取得 48.13 MAE。沿着这条路线，我持续补足 PyTorch、OpenCV、目标检测、密度估计与位姿解算的训练和工程化能力。
          </p>
          <p>
